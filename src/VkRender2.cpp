...
void VkRender2::render_imgui(CmdEncoder& cmd, ImageHandle img) {
  cmd.begin_rendering({.extent = device_->get_image(img)->size()},
                      {RenderingAttachmentInfo::color_att(img)});
